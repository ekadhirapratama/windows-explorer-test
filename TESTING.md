...
#### Folders API (`tests/integration/api/folders-api.test.ts`)
...
#### Search API (`tests/integration/api/search-api.test.ts`)
...
#### FolderRepository (`tests/unit/repositories/folder-repository.test.ts`)
- should be defined (Dependency Injection verification)

#### FolderService (`tests/unit/services/folder-service.test.ts`)
...
#### SearchService (`tests/unit/services/search-service.test.ts`)
...
#### ContentItem (`tests/unit/components/ContentItem.test.ts`)
...
#### GlobalSearch (`tests/unit/components/GlobalSearch.test.ts`)
- renders input field
...
#### useFolderTree (`tests/unit/composables/useFolderTree.test.ts`)
- loads root folders
- toggles folder expansion and loads children
- selects folder

#### useSearch (`tests/unit/composables/useSearch.test.ts`)
...
#### ContentItem (`tests/unit/visual/ContentItem.snapshot.test.ts`)
- renders folder item correctly
- renders file item correctly

#### FolderTreeNode (`tests/unit/visual/FolderTreeNode.snapshot.test.ts`)
- renders collapsed folder node
- renders selected expanded node

#### ExplorerLayout (`tests/unit/visual/ExplorerLayout.snapshot.test.ts`)
